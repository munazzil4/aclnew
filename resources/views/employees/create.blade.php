    	...
    	@csrf
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Basic:</strong>
		            <input type="text" name="basic" class="form-control" placeholder="Basic">
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Gross:</strong>
		            <input type="text" name="gross" class="form-control" placeholder="Gross">
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>EPF:</strong>
		            <input type="text" name="epf" class="form-control" placeholder="EPF">
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
